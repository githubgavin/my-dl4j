...
import com.udgrp.mnist.MnistUIExample;
...
/**
 * A version of ClassifyUIExample that shows how you can host the UI in a different JVM to the
 *
...
public class RemoteUIExample {
    ...
    public static void main(String[] args){
        ...
        MultiLayerNetwork net = MnistUIExample.getMnistNetwork();
        DataSetIterator trainData = MnistUIExample.getMnistData();
