...
public class TestEmotion extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String DATA_PATH = userDirectory ;
        ...
        try (BufferedReader brCategories = new BufferedReader(new FileReader(categories))) {
            ...
            System.out.println("label : " +labels.get(pos).split(",")[1]);
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Logger.getLogger(TestEmotion.class.getName()).log(Level.SEVERE, null, ex);
        ...
        TestEmotion test = new TestEmotion();
        ...
        try {
            ...
            net = ModelSerializer.restoreMultiLayerNetwork(userDirectory + "EmotionModel.model");
            ...
            System.out.println(wordVectors.vocab().words().size());
        } catch (Exception e) {
    ...
    private static DataSet prepareTestData(String i_news) {
        ...
        INDArray labels = Nd4j.create(news.size(), 3, maxLength);    //labels: 中立，正面，反面
