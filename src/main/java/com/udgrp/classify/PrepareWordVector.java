...
public class PrepareWordVector {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filePath = new File(classPathResource + File.separator + "words.txt").getAbsolutePath();
        ...
        WordVectorSerializer.writeWordVectors(vec.lookupTable(), new FileOutputStream("C:\\tmp\\搜狗文本分类语料库已分词v2.txt"));
    }
}
