...
public class TrainNews {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int batchSize = 58;     //Number of examples in each minibatch
        int nEpochs = 80;        //Number of epochs (full passes of training data) to train on
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                .learningRate(0.008)
                .list()
                .layer(0, new GravesLSTM.Builder().nIn(inputNeurons).nOut(400).activation(Activation.SOFTSIGN).build())
                .layer(1, new RnnOutputLayer.Builder().activation(Activation.SOFTMAX).lossFunction(LossFunctions.LossFunction.MCXENT).nIn(400).nOut(outputs).build())
                .pretrain(false)
                .backprop(true)
                .build();
